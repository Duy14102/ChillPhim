                            ...
                            <div key={i._id} className="bottomBodyChild">
                                ...
                                <div className="bottomBodyChildSide">
                                    ...
                                    <div className="sideChild">
                                        ...
                                        <button onClick={() => setState({ modalState: true, modalStateOptions: 6, deleteMovieId: i._id })} title="Xóa" type="button" className="deleteButton">
